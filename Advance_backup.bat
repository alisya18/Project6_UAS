...
set BACKUP_DIR=C:\Users\Alisya\Desktop\Backup_file
...
set SMTP_PORT=587
set EMAIL_FROM=alishalukman3@gmail.com
set EMAIL_TO=alisyaalisha35@gmail.com
set EMAIL_USER=alishalukman3@gmail.com
set EMAIL_PASS=ajxbkyixrncqrjba
